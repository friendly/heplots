...
-   [Friendly (2007)](http://datavis.ca/papers/jcgs-heplots.pdf) for the basic theory of HE plots on which this is based.
-   [Fox, Friendly and Monette (2009)](https://datavis.ca/papers/FoxFriendlyMonette-2009.pdf) for a brief introduction with a few worked R examples
-   [Friendly (2010)](https://www.jstatsoft.org/htaccess.php?volume=37&type=i&issue=04&filename=paper) for the extension of these ideas to repeated
    measure designs, with R examples
-   [Friendly, Monette and Fox (2013)](http://datavis.ca/papers/ellipses-STS402.pdf) for a general discussion of the role of elliptical geometry in statistical understanding--- ellipses and geometry are everywhere in statistical models. 
-   [Friendly & Sigal (2017)](https://doi.org/10.20982/tqmp.13.1.p020) for an applied R tutorial with examples of MANOVA and multivariate regression models for psychological data drawn from this package
...
The ideas behind this and related packages are now the subject of a forthcoming book,
[_Visualizing Multivariate Data and Models in R_](https://friendly.github.io/Vis-MLM-book/)
...
-   `stdmodel()` standardizes the numeric variables in a MLM model and `stdcoef()` give you
    standardized ("beta") coefficients that don't depend on units of measurement of the variables.
...
matrices in this transformed space. The paper [HE plots for repeated measures
...
`pkgdown` website, [<https://friendly.github.io/heplots/>].
...
refurl <- "https://friendly.github.io/heplots/reference/"
...
articles on the [pkgdown site](https://friendly.github.io/heplots/articles/):

```{r vignettes, echo=FALSE, results="asis"}
vigns <- as.data.frame(tools::getVignetteInfo("heplots")[, c("File", "Title")])
articleurl <- "https://friendly.github.io/heplots/articles/"
links <- glue::glue("- [{vigns$Title}]({articleurl}{tools::file_path_sans_ext(vigns$File)}.html)")
cat(links, sep = "\n")
```
...
designs](https://www.jstatsoft.org/htaccess.php?volume=37&type=i&issue=04&filename=paper). *Journal of
