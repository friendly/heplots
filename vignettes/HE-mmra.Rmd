...
We can test this assumption as follows, adding interactions of `SES`
...
and a course evaluation (`eval`).[^1]

[^1]:It is arguable that the students' course evaluation should not
