...
#' to \code{0.05}.
#' @param segments number of segments composing each ellipsoid; defaults to
#' \code{40}.
...
#' can be changed by assigning a color vector via \code{options(heplot3d.colors
#' =c(...)}.  Otherwise, the default colors are \code{c("pink", "blue",
