...
#' 
#' For univariate linear models, classical \eqn{\eta^2} = SSH / SST and partial
...
#' calculated as:
#' 
#' \describe{ \item{Pillai's trace (V)}{\eqn{\eta^2 = V/s}}
#' \item{Hotelling-Lawley trace (T)}{\eqn{\eta^2 = T/(T+s)}} \item{Wilks'
#' Lambda (L)}{\eqn{\eta^2 = L^{1/s}}} \item{Roy's maximum root
#' (R)}{\eqn{\eta^2 = R/(R+1)}} }
#' 
