...
dimensions), or by line segments in one dimension.

## Details

The basic theory behind HE plots is described by Friendly (2007). See
Fox, Friendly and Monette (2007) for a brief introduction; Friendly &
Sigal (2016) for a tutorial on these methods; and Friendly, Monette and
Fox (2013) for a general discussion of the role of elliptical geometry
